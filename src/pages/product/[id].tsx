            ...
            <Container maxW="container.xl">
                ...
                <Flex direction={{ base: "column", md: "row" }} gap={8}>
                    ...
                    <VStack align="start" spacing={4} flex={1}>
                        ...
                        <HStack>
                            {[...Array(5)].map((_, i) => (
                                <StarIcon key={i} color={i < 4 ? accentColor : "gray.300"} />
                            ))}
                            <Text color={textColor}>(4.0) 120 reviews</Text>
                        </HStack>
                        <Divider borderColor={borderColor} />
                        <Text color={textColor}>Synced: {new Date(product.synced).toLocaleString()}</Text>
                        <HStack spacing={4}>
                            <NumberInput
                                defaultValue={1}
                                min={1}
